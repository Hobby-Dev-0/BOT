...
""" Userbot module for managing events.
 One of the main components of the LEGEND. """
...
from LEGEND import bot, BOTLOG_CHATID, LOGSPAMMER
                ...
                if not disable_errors:
                    ...
                    if LOGSPAMMER:
                        await check.client.respond(
                            "`Sorry, my LEGEND has crashed😔, check logs for more info.\
                        \nThe error logs are stored in the LEGEND's log chat.`"
                        )
