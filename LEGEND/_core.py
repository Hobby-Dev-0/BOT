...
from LEGEND.utils import admin_cmd, load_module, remove_plugin, sudo_cmd
from LEGEND.utils import edit_or_reply as eor
...
async def send(event):
    ...
    the_plugin_file = "./LEGEND/plugins/{}.py".format(input_str)
